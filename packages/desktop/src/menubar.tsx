...
import type { HeatmapPoint, TimelineMetric } from '@ohmyc/ui/hooks/use-timeline'

const CURRENT_YEAR = new Date().getFullYear()
const METRIC: TimelineMetric = 'sessions'
...
export function Menubar() {
  ...
  return (
    <div style={{ padding: 18, background: '#191a1b', color: '#f7f8f8', minHeight: '100vh' }}>
      ...
      <ContributionGraph year={CURRENT_YEAR} metric={METRIC} data={stubData} />
    </div>
  )
}
