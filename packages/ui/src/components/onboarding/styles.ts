/**
 * Shared RetroComputerAtropos scene styles — absolute layer positioning, depth
 * offsets, and per-layer image transforms. Needed wherever RetroComputerAtropos
 * renders (OnboardingGate AND MenubarOnboard). These are also included inline
 * in onboardingStyles below for the full gate.
 */
export const retroComputerSceneStyles = `
