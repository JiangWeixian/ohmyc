...
export class ConfigLocator {
  ...
  get agentsDir(): string { return path.join(this.writeBaseDir, 'agents'); }
  ...
  get readBaseDir(): string { return this.writeBaseDir; }
