...
import { configsRoutes } from '@/server/routes/configs'
...
describe('configs routes', () => {
  ...
  beforeEach(async () => {
    ...
    app = Fastify()
    await app.register(configsRoutes, { baseDir: tmpDir, projectBaseDir: projectDir, pluginsDir, claudeSettingsPaths: [settingsPath] })
    await app.ready()
  })
